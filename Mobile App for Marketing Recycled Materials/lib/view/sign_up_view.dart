...
import 'package:trial/features/form-validation/bloc/form_bloc.dart';
...
class _DisplayUserCategory extends StatelessWidget {
  ...
  _DisplayUserCategory({Key? key}) : super(key: key);
        ...
        return SizedBox(
          ...
          child: DropdownButton(
            ...
            onChanged: (String? value) {
              dropdownvalue = value!;
              context.read<FormBloc>().add(UserCatChanged(value));
            },
          ...
          //     errorMaxLines: 2,
          //     errorText:
          //         !state.isUserCatValid ? '''Name cannot be empty!''' : null,
          //   ),
          //   onChanged: (value) {
          //     context.read<FormBloc>().add(UserCatChanged(value));
          //   },
